...
function gracecode_buildinfo() {
  ...
  var func1 = function(argcv) {    // method gitrevision
    ...
    var curarg = 1;
    setModuleName("buildinfo");
    var string2 = new GraceString("61e47c1e847de6ea2a01ee86a2c21f2974329566");
    return string2;
  };
  func1.paramCounts = [0];
  ...
  var func3 = function(argcv) {    // method gitgeneration
    ...
    var curarg = 1;
    setModuleName("buildinfo");
    var string4 = new GraceString("3390");
    return string4;
  };
  func3.paramCounts = [0];
...
if (typeof originalSourceLines !== "undefined") {
  originalSourceLines["buildinfo"] = [
    "method gitrevision { \"61e47c1e847de6ea2a01ee86a2c21f2974329566\" }",
    "method gitgeneration { \"3390\" }",
    "method prefix { \"/usr\" }",
