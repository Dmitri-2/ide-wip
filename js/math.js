...
function gracecode_math() {
  ...
  var func1 = function(argcv) {    // method sin(_)
    ...
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat2)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method sin(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat2;
  };
  func1.paramTypes = [];
  ...
  var func3 = function(argcv) {    // method cos(_)
    ...
    var nat4 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat4)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method cos(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat4;
  };
  func3.paramTypes = [];
  ...
  var func5 = function(argcv) {    // method tan(_)
    ...
    var nat6 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat6)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method tan(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat6;
  };
  func5.paramTypes = [];
  ...
  var func7 = function(argcv) {    // method asin(_)
    ...
    var nat8 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat8)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method asin(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat8;
  };
  func7.paramTypes = [];
  ...
  var func9 = function(argcv) {    // method acos(_)
    ...
    var nat10 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat10)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method acos(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat10;
  };
  func9.paramTypes = [];
  ...
  var func11 = function(argcv) {    // method atan(_)
    ...
    var nat12 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat12)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method atan(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat12;
  };
  func11.paramTypes = [];
  ...
  var func13 = function(argcv) {    // method random
    ...
    var nat14 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat14)))
        throw new GraceExceptionPacket(TypeErrorObject,
  ...
  var func15 = function(argcv) {    // method π
    ...
    var nat16 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat16)))
        throw new GraceExceptionPacket(TypeErrorObject,
  ...
  var func17 = function(argcv) {    // method pi
    ...
    var nat18 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat18)))
        throw new GraceExceptionPacket(TypeErrorObject,
  ...
  var func19 = function(argcv) {    // method sqrt(_)
    var returnTarget = invocationCount;
    invocationCount++;
    var curarg = 1;
    var var_a = arguments[curarg];
    ...
    var nat20 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat20)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method sqrt(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat20;
  };
  func19.paramTypes = [];
  ...
  var func21 = function(argcv) {    // method abs(_)
    ...
    var nat22 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat22)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method abs(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat22;
  };
  func21.paramTypes = [];
  ...
  var func23 = function(argcv) {    // method lg(_)
    ...
    var nat24 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat24)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method lg(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat24;
  };
  func23.paramTypes = [];
  ...
  var func25 = function(argcv) {    // method ln(_)
    ...
    var nat26 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat26)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method ln(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat26;
  };
  func25.paramTypes = [];
  ...
  var func27 = function(argcv) {    // method exp(_)
    ...
    var nat28 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat28)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method exp(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat28;
  };
  func27.paramTypes = [];
  ...
  var func29 = function(argcv) {    // method log10(_)
    ...
    var nat30 = result;
       // end native code insertion
    if (!Grace_isTrue(callmethod(var_Number, "match(1)", [1], nat30)))
        throw new GraceExceptionPacket(TypeErrorObject,
            new GraceString("result of method log10(_) does not have " + 
                callmethod(var_Number, "asString", [0])._value + "."));
    return nat30;
  };
  func29.paramTypes = [];
